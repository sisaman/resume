...
\begin{tabu} to \textwidth {X[l]X[r]}
	...
	1920 Martigny & \hfill{\href{mailto:sina.sajadmanesh@epfl.ch}{sina.sajadmanesh@epfl.ch}~\faEnvelope} \\ 
...
\begin{innerlist}
    \item[] \textbf{\href{https://brave.com/}{Brave Software}}, London, UK (Remote)
    \if\longversion1
    \begin{innerlist}
    	\item Working on privacy-preserving user representation learning and recommendation systems.
    \end{innerlist}
  	\fi
\end{innerlist}
