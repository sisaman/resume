...
\textit{Working as a member of the Privacy-Preserving Machine Learning team to contribute to the development of secure and trustworthy AI solutions.}
  % \begin{innerlist}
  %   \item \textbf{Developed a federated learning framework} to enable privacy-preserving training of deep learning models on distributed data.
  %   \item \textbf{Developed a differentially private federated learning framework} to enable privacy-preserving training of deep learning models on distributed data.
  % \end{innerlist}
