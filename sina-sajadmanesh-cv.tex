...
\begin{tabu} to \textwidth {X[l]X[r]}
	...
	Station 14, CH-1015 Lausanne & \hfill{\href{https://sajadmanesh.com}{https://sajadmanesh.com}~\faHome} \\
\end{tabu}
\endgroup
%
...
\textbf{Privacy-Preserving Deep Learning on Graphs}
\begin{innerlist}
	\item[] Socially Responsible AI Course, University of Illinois at Chicago (Remote), October 2022
	\item[] {Information Processing and Communications Lab}, {{Imperial College London}} (Remote), {Dec 2020}
\end{innerlist}
